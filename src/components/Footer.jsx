  ...
  return (
    <footer className='bg-gray-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            <Link to='/'>
              ...
              <h1 className='text-red-500 text-2xl font-bold'>ECom</h1>
            </Link>
            <p className='mt-2 text-sm'>Powering Your World with the Best in Electronics.</p>
            <p className='mt-2 text-sm'>123 Electronics St, Budaun, 243601</p>
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()} <span className='text-red-500'>ECom</span>. All rights reserved</p>
      </div>
    </footer>
  )
}
